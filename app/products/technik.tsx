...
const CATEGORIES = [
  { id: '1', emoji: '💻', title: 'Laptops' },
  { id: '2', emoji: '📱', title: 'Smartphones' },
  { id: '3', emoji: '🎧', title: 'Kopfhörer' },
  { id: '4', emoji: '⌚️', title: 'Smartwatches' },
  { id: '5', emoji: '📺', title: 'Fernseher' },
  { id: '6', emoji: '📷', title: 'Kameras' },
  { id: '7', emoji: '🎮', title: 'Konsolen & Gaming' },
  { id: '8', emoji: '🖥️', title: 'Monitore' },
];
...
export default function TechnikScreen() {
  ...
  const handleCategoryPress = (category: string) => {
    if (category === 'Laptops') {
      router.push('/products/technik/laptops');
    }
  };
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Wähle eine Unterkategorie</Text>
        </View>
